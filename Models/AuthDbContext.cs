...
namespace FreshFarmMarket.Models
{
    public class ApplicationUser : IdentityUser
    {
        ...
        public string AboutMe { get; set; } = "Welcome to Fresh Farm Market!"; 
        public string ProfilePhotoPath { get; set; } = "/uploads/default-profile.png"; 
        public string CreditCardNo { get; set; } = "EncryptedDefaultCC"; 
    ...
    public class AuthDbContext : IdentityDbContext<ApplicationUser, IdentityRole, string>
    {
        ...
        protected override void OnModelCreating(ModelBuilder builder)
        {
            ...
            builder.Entity<ApplicationUser>().HasData(new ApplicationUser
            {
                ...
                PasswordHash = "DPk7iS1poQpU6JP43Gqw2wzWg9VHpvosdZWcZG2Ty+s=",
